...
public class custinfo extends JFrame {
	...
	public custinfo() {
     ...
     try
     {
   	  String query="Select customer.Customer_Name,customer.Gender,customer.C_ID,loan_type.Loan_Name AS Loan_Type,customer_loan.Loan_ID,customer_loan.Balance,customer_loan.Total_EMI,customer_loan.EMI_Submitted,customer.Email_ID,customer.Address,customer.City,customer.State,customer.Phone,customer.Occupation,customer.Annual_Income "
